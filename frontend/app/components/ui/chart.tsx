...
// ✅ PAKAI TooltipProps, BUKAN ComponentProps<typeof Tooltip>
type BaseTooltipProps = RechartsPrimitive.TooltipProps<number, string>;

type ChartTooltipContentProps = BaseTooltipProps &
